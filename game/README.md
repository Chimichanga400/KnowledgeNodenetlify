...
| 🏰 Empire | An isometric "base of operations" view (Townsmen / Diablo angle), drawn live on canvas. Your HQ building upgrades with your grandest estate (shed → manor → castle → island fortress), front businesses become shops lining the street, luxuries appear in the grounds (the Jaguar, the boat), and little people walk up and down — civilians plus your runners, enforcers, gardeners, and police when heat is high. Lighting tracks the clock (windows and streetlamps glow at night). When a war fires — a takeover, raid, or hit — you see the clash happen, and the tab pulses if you weren't watching. |
