...
| Loop | What you do |
|---|---|
| 🌱 Grow | Buy seeds (street cash), plant, keep watered, harvest. 8 strains unlock with reputation, across 7 leasable estates. The tab opens with a portrait of **your current residence** (your grandest estate). Plants are drawn live and visibly grow, wilt, and ripen. **Hand-harvesting** launches a timing "trim" minigame — land the marker in the golden band for a Perfect Trim (+40% yield). Gardeners auto-harvest but only at base yield, so skilled manual play out-earns automation. |
...
| 🏙️ Empire | An isometric **city** view (Townsmen / Diablo angle), drawn live on canvas. Every estate you hold becomes a building on a grid of streets — grandest at the centre — with tower blocks and terraces filling in around them as your rep and wealth grow (shed → manor → castle → island fortress). Front businesses line a market row, luxuries appear in the streets (the Jaguar, the boat), turf you hold flies a green flag, and dozens of little people walk the avenues — civilians plus your runners, enforcers, gardeners, and police when heat is high. Lighting tracks the clock (windows and streetlamps glow at night). When a war fires — a takeover, raid, or hit — you see the clash happen, and the tab pulses if you weren't watching. |
